...
void menu(Plumber plumberList[], Deliver deliverList[], Driver driverList[], int n, int m, int l)
{
    ...
    do
    {
        ...
        case 1:
        {
            ...
            // thêm đối tượng giá trị "plumber" vào danh sách "plumberList"
        ...
        case 2:
        {
            ...
            // thêm đối tượng giá trị "deliver" vào danh sách "deliverList"
        ...
        case 3:
        {
            ...
            // thêm đối tượng giá trị "driver" vào danh sách "driverList"
            driverList[l] = driver;
            l++;
            break;
        }
...
int main()
{
    ...
    Plumber plumberList[100];
    Deliver deliverList[100];
